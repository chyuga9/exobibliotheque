...
import com.example.exobibliotheque.service.CategoryService;
...
public class CategoryController {
	...
	public ResponseEntity<Iterable<Category>> getCatégories() {
		logger.info("Controller - Recherche de toutes les catégories");
